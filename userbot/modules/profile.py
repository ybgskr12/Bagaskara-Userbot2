...
@bot.on(cilik_cmd(outgoing=True, pattern=r"name"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"count$"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(cilik_cmd(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
