...
@bot.on(cilik_cmd(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
