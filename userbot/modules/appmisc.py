...
@cilik_cmd(pattern="remove(?: |$)(.*)", allow_sudo=False)
async def _(event):
    if event.fwd_from:
        return
    if event.is_private:
...
@cilik_cmd(pattern="doublestruck(?: |$)(.*)")
