...
@bot.on(cilik_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"rmwelcome$"))
