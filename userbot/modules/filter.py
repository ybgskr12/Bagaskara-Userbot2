...
@bot.on(cilik_cmd(outgoing=True, pattern=r"filter (.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"stop (.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"delfilterbot (.*)"))
...
@bot.on(cilik_cmd(outgoing=True, pattern=r"filters$"))
